...
>
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Servicio premium de lavado de autos MetroWash"
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20">
        <div className="max-w-3xl">
          ...
          {/* Heading */}
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-background mb-6 animate-fade-in-up animation-delay-100">
